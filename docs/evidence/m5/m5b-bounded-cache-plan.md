...
先更新 `docs/design/observability-metrics.md` 的 M5B 演进小节，再编码。保留现有名称并只增加有限枚举：
...
| 指标 | `LocalDealsMetrics`、`docs/design/observability-metrics.md` 的 M5B 增量说明 |
...
- [ ] 阅读 `docs/design/blog-like-outbox-hot-rank.md`，确认不改 generation/like 真相边界；
...
- [ ] 执行 `git diff --check`；
- [ ] 形成 `docs/evidence/m5/m5b-bounded-cache-results.md` 与 `docs/evidence/m5/m5b-bounded-cache-summary.csv`；
- [ ] README 只写已验证事实和边界；
...
2. /home/sd101t/IdeaProjects/hm-dianping/docs/evidence/m5/m5b-bounded-cache-plan.md
3. /home/sd101t/IdeaProjects/hm-dianping/docs/evidence/m5/m5a-observability-results.md
4. /home/sd101t/IdeaProjects/hm-dianping/docs/design/observability-metrics.md
5. /home/sd101t/IdeaProjects/hm-dianping/docs/design/blog-like-outbox-hot-rank.md
