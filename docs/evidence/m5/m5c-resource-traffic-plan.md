...
>
> 前置结果：`docs/evidence/m5/m5a-observability-results.md`、`docs/evidence/m5/m5b-bounded-cache-results.md`
...
在 `LocalDealsMetrics` 和 `docs/design/observability-metrics.md` 增加 M5C 有限扩展：
...
| 指标 | `LocalDealsMetrics`、`docs/design/observability-metrics.md` |
...
- [ ] 新增 `docs/evidence/m5/m5c-resource-traffic-results.md`；
- [ ] 新增 `docs/evidence/m5/m5c-resource-traffic-summary.csv`；
...
docs/evidence/m5/m5c-resource-traffic-plan.md、docs/evidence/m5/m5a-observability-results.md 和
docs/evidence/m5/m5b-bounded-cache-results.md，只实施 M5C。
