...
- S1/S2/warmup 汇总、JTL、Prometheus 前后快照和 consumerProgress 保留在本地忽略目录 `benchmark/pre-m8/m7rc_20260823i/`，不进入 Git。
- i 轮显式 IT 日志保留在本地 `benchmark/pre-m8/m7rc_20260823i/tests/`。
