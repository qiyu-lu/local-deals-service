...
- retry_key_count: 0
- correctness: pass
- reset_log: docs/archive/redis-stream/reliability-results/2026-05-20-seckill-baseline-lua-stream-fault-injection-r1-reset.log
- metrics_csv: docs/archive/redis-stream/reliability-results/metrics.csv
